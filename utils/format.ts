...
export function formatDate(date: string, pattern: string = DateFormat.DateTime) {
  return date ? format(parseISO(date), pattern) : '-'
}

export function formatDateDistance(date: string, pattern: string = DateFormat.DateTime) {
  if (date) {
